...
/*
    ...
    (as in "cc -DNBLAS", for example).  These flags are normally placed in
	...
	-DMATHWORKS
	    ...
	    in MATLAB.  The -DNRECIPROCAL flag is turned on.
...
/*
    ...
    options are set in the UFconfig/UFconfig.mk file.
    ...
    directory.  You do not need to do this for the SGI, which has a
    /usr/include/cblas.h.
*/
