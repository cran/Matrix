...
\title{UMFPACK Version 4.5 Quick Start Guide}
\date{Aug. 30, 2005}
\maketitle
...
UMFPACK Version 4.5, Copyright\copyright 2005 by Timothy A. Davis.
...
UMFPACK Version 4.3 is a built-in routine in MATLAB 7.0.4, used by the forward and
...
You will need to install both UMFPACK v4.5 and AMD v1.2 to use UMFPACK.
Note that UMFPACK v4.5 cannot use AMD v1.1 or earlier.
