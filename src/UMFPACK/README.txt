UMFPACK Version 4.5:  a set of routines solving sparse linear systems via LU
    ...
    a subset of the C-callable routines.  Requires AMD Version 1.2 or later.
...
UMFPACK Version 4.5, Copyright (c) 2005 by Timothy A.  Davis.
All Rights Reserved.
...
UMFPACK v4.5 cannot user AMD v1.1 or earlier.  It requires AMD v1.2 or later.
...
Description:
    ...
    also be compiled without any BLAS at all.  UMFPACK requires AMD Version 1.2.
