...
\end{Sinput}
\begin{Soutput}
c(0.00508571428571437, 0.876285714285715)
\end{Soutput}
\begin{Sinput}
> dput(unname(lm.fit(m, yo)$coefficients))
\end{Sinput}
\begin{Soutput}
c(0.00508571428571436, 0.876285714285714)
\end{Soutput}
\end{Schunk}
%$
...
\end{Sinput}
\begin{Soutput}
[1] 4.426 0.177 3.442 0.000 0.000
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
[1] 0.991 0.069 0.763 0.000 0.000
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] 1.258 0.039 0.723 0.000 0.000
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
[1] 0.804 0.046 0.647 0.000 0.000
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] 0.075 0.058 0.124 0.000 0.000
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] 0.820 0.055 0.602 0.000 0.000
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] 0.144 0.020 0.164 0.000 0.000
\end{Soutput}
\begin{Sinput}
> system.time(solve(xpx, xpy))
\end{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] 0.057 0.002 0.060 0.000 0.000
\end{Soutput}
\begin{Sinput}
