...
echo 'Do check that you did *not* forget one of the *.po or generated *.mo files, via'; echo ''
echo "       svn st -v po inst/po  | grep '^?'"; echo ''
echo 'and commit with something like'
