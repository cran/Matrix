...
\usepackage{/unsup/R-2.3.1/lib/R/share/texmf/Sweave}
\begin{document}
...
\end{Sinput}
\begin{Soutput}
[1] 2.151 0.114 2.268 0.000 0.000
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
[1] 1.388 0.041 1.429 0.000 0.000
\end{Soutput}
\begin{Sinput}
...
%% ---- which one ? {every time the vignette's is rebuilt ..}
...
\end{Sinput}
\begin{Soutput}
[1] 0.087 0.012 0.098 0.000 0.000
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
[1] 1.470 0.015 1.486 0.000 0.000
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] 0.024 0.050 0.073 0.000 0.000
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] 1.482 0.019 1.501 0.000 0.000
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] 0.144 0.008 0.151 0.000 0.000
\end{Soutput}
\begin{Sinput}
> system.time(solve(xpx, xpy))
\end{Sinput}
\begin{Soutput}
[1] 0.003 0.000 0.002 0.000 0.000
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
[1] 0.039 0.000 0.039 0.000 0.000
\end{Soutput}
\begin{Sinput}
