\hypertarget{R__ldl_8h}{
\subsection{R\_\-ldl.h File Reference}
\label{R__ldl_8h}\index{R_ldl.h@{R\_\-ldl.h}}
}
{\tt \#include $<$R\_\-ext/RS.h$>$}\par
{\tt \#include $<$R\_\-ext/Memory.h$>$}\par
\subsubsection*{Functions}
\begin{CompactItemize}
\item 
void \hyperlink{R__ldl_8h_a0}{R\_\-ldl\_\-symbolic} (int n, const int Ap\mbox{[}$\,$\mbox{]}, const int Ai\mbox{[}$\,$\mbox{]}, int Lp\mbox{[}$\,$\mbox{]}, int Parent\mbox{[}$\,$\mbox{]}, const int P\mbox{[}$\,$\mbox{]}, int Pinv\mbox{[}$\,$\mbox{]})
\item 
int \hyperlink{R__ldl_8h_a1}{R\_\-ldl\_\-numeric} (int n, const int Ap\mbox{[}$\,$\mbox{]}, const int Ai\mbox{[}$\,$\mbox{]}, const double Ax\mbox{[}$\,$\mbox{]}, const int Lp\mbox{[}$\,$\mbox{]}, const int Parent\mbox{[}$\,$\mbox{]}, int Li\mbox{[}$\,$\mbox{]}, double Lx\mbox{[}$\,$\mbox{]}, double D\mbox{[}$\,$\mbox{]}, const int P\mbox{[}$\,$\mbox{]}, const int Pinv\mbox{[}$\,$\mbox{]})
\item 
void \hyperlink{R__ldl_8h_a2}{R\_\-ldl\_\-lsolve} (int n, double X\mbox{[}$\,$\mbox{]}, const int Lp\mbox{[}$\,$\mbox{]}, const int Li\mbox{[}$\,$\mbox{]}, const double Lx\mbox{[}$\,$\mbox{]})
\item 
void \hyperlink{R__ldl_8h_a3}{R\_\-ldl\_\-dsolve} (int n, double X\mbox{[}$\,$\mbox{]}, const double D\mbox{[}$\,$\mbox{]})
\item 
void \hyperlink{R__ldl_8h_a4}{R\_\-ldl\_\-ltsolve} (int n, double X\mbox{[}$\,$\mbox{]}, const int Lp\mbox{[}$\,$\mbox{]}, const int Li\mbox{[}$\,$\mbox{]}, const double Lx\mbox{[}$\,$\mbox{]})
\item 
void \hyperlink{R__ldl_8h_a5}{R\_\-ldl\_\-perm} (int n, double X\mbox{[}$\,$\mbox{]}, const double B\mbox{[}$\,$\mbox{]}, const int P\mbox{[}$\,$\mbox{]})
\item 
void \hyperlink{R__ldl_8h_a6}{R\_\-ldl\_\-permt} (int n, double X\mbox{[}$\,$\mbox{]}, const double B\mbox{[}$\,$\mbox{]}, const int P\mbox{[}$\,$\mbox{]})
\item 
int \hyperlink{R__ldl_8h_a7}{R\_\-ldl\_\-valid\_\-perm} (int n, const int P\mbox{[}$\,$\mbox{]})
\item 
int \hyperlink{R__ldl_8h_a8}{R\_\-ldl\_\-valid\_\-matrix} (int n, const int Ap\mbox{[}$\,$\mbox{]}, const int Ai\mbox{[}$\,$\mbox{]})
\end{CompactItemize}


\subsubsection{Function Documentation}
\hypertarget{R__ldl_8h_a3}{
\index{R_ldl.h@{R\_\-ldl.h}!R_ldl_dsolve@{R\_\-ldl\_\-dsolve}}
\index{R_ldl_dsolve@{R\_\-ldl\_\-dsolve}!R_ldl.h@{R\_\-ldl.h}}
...
\end{Desc}
\hypertarget{R__ldl_8h_a2}{
\index{R_ldl.h@{R\_\-ldl.h}!R_ldl_lsolve@{R\_\-ldl\_\-lsolve}}
\index{R_ldl_lsolve@{R\_\-ldl\_\-lsolve}!R_ldl.h@{R\_\-ldl.h}}
...
\end{Desc}
\hypertarget{R__ldl_8h_a4}{
\index{R_ldl.h@{R\_\-ldl.h}!R_ldl_ltsolve@{R\_\-ldl\_\-ltsolve}}
\index{R_ldl_ltsolve@{R\_\-ldl\_\-ltsolve}!R_ldl.h@{R\_\-ldl.h}}
...
\item[{\em n}]L is n-by-n, where n $>$= 0 \item[{\em X}]size n. right-hand-side on input, soln. on output \item[{\em Lp}]column pointer array of size n+1 \item[{\em Li}]row index array of size lnz=Lp\mbox{[}n\mbox{]} \item[{\em Lx}]non-zero off-diagonal elements (size lnz=Lp\mbox{[}n\mbox{]}) \end{description}
\end{Desc}
\hypertarget{R__ldl_8h_a1}{
\index{R_ldl.h@{R\_\-ldl.h}!R_ldl_numeric@{R\_\-ldl\_\-numeric}}
\index{R_ldl_numeric@{R\_\-ldl\_\-numeric}!R_ldl.h@{R\_\-ldl.h}}
...
\hypertarget{R__ldl_8h_a5}{
\index{R_ldl.h@{R\_\-ldl.h}!R_ldl_perm@{R\_\-ldl\_\-perm}}
\index{R_ldl_perm@{R\_\-ldl\_\-perm}!R_ldl.h@{R\_\-ldl.h}}
...
\end{Desc}
\hypertarget{R__ldl_8h_a6}{
\index{R_ldl.h@{R\_\-ldl.h}!R_ldl_permt@{R\_\-ldl\_\-permt}}
\index{R_ldl_permt@{R\_\-ldl\_\-permt}!R_ldl.h@{R\_\-ldl.h}}
...
\item[{\em n}]size of X, B, and P \item[{\em X}]output of size n \item[{\em B}]input of size n \item[{\em P}]input permutation array of size n \end{description}
\end{Desc}
\hypertarget{R__ldl_8h_a0}{
\index{R_ldl.h@{R\_\-ldl.h}!R_ldl_symbolic@{R\_\-ldl\_\-symbolic}}
\index{R_ldl_symbolic@{R\_\-ldl\_\-symbolic}!R_ldl.h@{R\_\-ldl.h}}
...
\end{Desc}
\hypertarget{R__ldl_8h_a8}{
\index{R_ldl.h@{R\_\-ldl.h}!R_ldl_valid_matrix@{R\_\-ldl\_\-valid\_\-matrix}}
\index{R_ldl_valid_matrix@{R\_\-ldl\_\-valid\_\-matrix}!R_ldl.h@{R\_\-ldl.h}}
...
\hypertarget{R__ldl_8h_a7}{
\index{R_ldl.h@{R\_\-ldl.h}!R_ldl_valid_perm@{R\_\-ldl\_\-valid\_\-perm}}
\index{R_ldl_valid_perm@{R\_\-ldl\_\-valid\_\-perm}!R_ldl.h@{R\_\-ldl.h}}
