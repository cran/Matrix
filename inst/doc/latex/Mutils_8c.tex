...
\item 
void \hyperlink{Mutils_8c_a16}{make\_\-array\_\-triangular} (double $\ast$to, SEXP from)
\item 
SEXP \hyperlink{Mutils_8c_a17}{nlme\_\-replace\-Slot} (SEXP obj, SEXP names, SEXP value)
\item 
SEXP \hyperlink{Mutils_8c_a18}{nlme\_\-weight\_\-matrix\_\-list} (SEXP MLin, SEXP wts, SEXP adjst, SEXP MLout)
\item 
SEXP \hyperlink{Mutils_8c_a19}{Matrix\_\-make\_\-named} (int TYP, char $\ast$$\ast$names)
\item 
SEXP \hyperlink{Mutils_8c_a20}{alloc3Darray} (SEXPTYPE mode, int nrow, int ncol, int nface)
\item 
double $\ast$ \hyperlink{Mutils_8c_a21}{expand\_\-csc\_\-column} (double $\ast$dest, int m, int j, const int Ap\mbox{[}$\,$\mbox{]}, const int Ai\mbox{[}$\,$\mbox{]}, const double Ax\mbox{[}$\,$\mbox{]})
\end{CompactItemize}
