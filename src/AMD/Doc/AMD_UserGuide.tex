...
AMD Version 1.2, Copyright\copyright 2005 by Timothy A.
...
({\tt long} version: {\tt amd\_valid})
    ...
    Returns {\tt TRUE} (1) if the matrix is valid as input to {\tt amd\_order},
    {\tt FALSE} (0) otherwise.  For {\tt amd\_order}, the matrix must
...
New in version 1.2 is the ability to redefine the memory manager and
{\tt printf} routine.
Refer to Section~\ref{Primary} for more details.
