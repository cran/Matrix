...
\item 
static void \hyperlink{lmer_8c_a11}{lmer\_\-sm} (enum \hyperlink{Mutils_8h_a63}{CBLAS\_\-SIDE} side, enum \hyperlink{Mutils_8h_a60}{CBLAS\_\-TRANSPOSE} trans, int nf, const int Gp\mbox{[}$\,$\mbox{]}, int n, double alpha, SEXP L, double B\mbox{[}$\,$\mbox{]}, int ldb)
\item 
...
\item 
SEXP \hyperlink{lmer_8c_a30}{lmer\_\-fitted} (SEXP x, SEXP mmats, SEXP use\-Rf)
\end{CompactItemize}
...
\hypertarget{lmer_8c_a30}{
\index{lmer.c@{lmer.c}!lmer_fitted@{lmer\_\-fitted}}
\index{lmer_fitted@{lmer\_\-fitted}!lmer.c@{lmer.c}}
...
\paragraph[lmer\_\-sm]{\setlength{\rightskip}{0pt plus 5cm}static void lmer\_\-sm (enum \hyperlink{Mutils_8h_a63}{CBLAS\_\-SIDE} {\em side}, enum \hyperlink{Mutils_8h_a60}{CBLAS\_\-TRANSPOSE} {\em trans}, int {\em nf}, const int {\em Gp}\mbox{[}$\,$\mbox{]}, int {\em n}, double {\em alpha}, SEXP {\em L}, double {\em B}\mbox{[}$\,$\mbox{]}, int {\em ldb})\hspace{0.3cm}{\tt  \mbox{[}static\mbox{]}}}\hfill}
\label{lmer_8c_a11}
