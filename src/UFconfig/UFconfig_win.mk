#===============================================================================
# UFconfig_win.mk:  R Windows version of common configuration file for all UF sparse matrix packages
#===============================================================================
...
# Pentium 4 (512K cache, 4GB main memory) with the Goto BLAS.
#
...
# These settings will probably not work, since their is no fixed convention for
# nameing the BLAS and LAPACK library (*.a or *.so) files.
...
# CFLAGS = -g -fexceptions
  CFLAGS = -O3 -fexceptions
  BLAS = -lgoto -lfrtbegin -lg2c $(XERBLA)

# Using Intel's icc and ifc compilers (untested)
# F77 = ifc
# CC = icc
